    ...
    items: [
      {
        id: 1,
        name: 'Brown Brim',
        imageUrlRemote: 'https://i.ibb.co/ZYW3VTp/brown-brim.png',
      ...
      },
      {
        id: 2,
        name: 'Blue Beanie',
        imageUrlRemote: 'https://i.ibb.co/ypkgK0X/blue-beanie.png',
      ...
      },
      {
        id: 3,
        name: 'Brown Cowboy',
        imageUrlRemote: 'https://i.ibb.co/QdJwgmp/brown-cowboy.png',
      ...
      },
      {
        id: 4,
        name: 'Grey Brim',
        imageUrlRemote: 'https://i.ibb.co/RjBLWxB/grey-brim.png',
      ...
      },
      {
        id: 5,
        name: 'Green Beanie',
        imageUrlRemote: 'https://i.ibb.co/YTjW3vF/green-beanie.png',
      ...
      },
      {
        id: 6,
        name: 'Palm Tree Cap',
        imageUrlRemote: 'https://i.ibb.co/rKBDvJX/palm-tree-cap.png',
      ...
      },
      {
        id: 7,
        name: 'Red Beanie',
        imageUrlRemote: 'https://i.ibb.co/bLB646Z/red-beanie.png',
      ...
      },
      {
        id: 8,
        name: 'Wolf Cap',
        imageUrlRemote: 'https://i.ibb.co/1f2nWMM/wolf-cap.png',
      ...
      },
      {
        id: 9,
        name: 'Blue Snapback',
        imageUrlRemote: 'https://i.ibb.co/X2VJP2W/blue-snapback.png',
    ...
    items: [
      {
        id: 10,
        name: 'Adidas NMD',
        imageUrlRemote: 'https://i.ibb.co/0s3pdnc/adidas-nmd.png',
      ...
      },
      {
        id: 11,
        name: 'Adidas Yeezy',
        imageUrlRemote: 'https://i.ibb.co/dJbG1cT/yeezy.png',
      ...
      },
      {
        id: 12,
        name: 'Black Converse',
        imageUrlRemote: 'https://i.ibb.co/bPmVXyP/black-converse.png',
      ...
      },
      {
        ...
        imageUrlRemote: 'https://i.ibb.co/1RcFPk0/white-nike-high-tops.png',
      ...
      },
      {
        ...
        imageUrlRemote: 'https://i.ibb.co/QcvzydB/nikes-red.png',
      ...
      },
      {
        ...
        imageUrlRemote: 'https://i.ibb.co/fMTV342/nike-brown.png',
      ...
      },
      {
        ...
        imageUrlRemote: 'https://i.ibb.co/w4k6Ws9/nike-funky.png',
      ...
      },
      {
        id: 17,
        name: 'Timberlands',
        imageUrlRemote: 'https://i.ibb.co/Mhh6wBg/timberlands.png',
    ...
    items: [
      {
        ...
        imageUrlRemote: 'https://i.ibb.co/XzcwL5s/black-shearling.png',
      ...
      },
      {
        ...
        imageUrlRemote: 'https://i.ibb.co/mJS6vz0/blue-jean-jacket.png',
      ...
      },
      {
        ...
        imageUrlRemote: 'https://i.ibb.co/N71k1ML/grey-jean-jacket.png',
      ...
      },
      {
        ...
        imageUrlRemote: 'https://i.ibb.co/s96FpdP/brown-shearling.png',
      ...
      },
      {
        id: 22,
        name: 'Tan Trench',
        imageUrlRemote: 'https://i.ibb.co/M6hHc3F/brown-trench.png',
    ...
    items: [
      {
        id: 23,
        name: 'Blue Tanktop',
        imageUrlRemote: 'https://i.ibb.co/7CQVJNm/blue-tank.png',
      ...
      },
      {
        id: 24,
        name: 'Floral Blouse',
        imageUrlRemote: 'https://i.ibb.co/4W2DGKm/floral-blouse.png',
      ...
      },
      {
        id: 25,
        name: 'Floral Dress',
        imageUrlRemote: 'https://i.ibb.co/KV18Ysr/floral-skirt.png',
      ...
      },
      {
        id: 26,
        name: 'Red Dots Dress',
        imageUrlRemote: 'https://i.ibb.co/N3BN1bh/red-polka-dot-dress.png',
      ...
      },
      {
        ...
        imageUrlRemote: 'https://i.ibb.co/KmSkMbH/striped-sweater.png',
      ...
      },
      {
        ...
        imageUrlRemote: 'https://i.ibb.co/v1cvwNf/yellow-track-suit.png',
      ...
      },
      {
        id: 29,
        name: 'White Blouse',
        imageUrlRemote: 'https://i.ibb.co/qBcrsJg/white-vest.png',
    ...
    items: [
      {
        id: 30,
        name: 'Camo Down Vest',
        imageUrlRemote: 'https://i.ibb.co/xJS0T3Y/camo-vest.png',
      ...
      },
      {
        id: 31,
        name: 'Floral T-shirt',
        imageUrlRemote: 'https://i.ibb.co/qMQ75QZ/floral-shirt.png',
      ...
      },
      {
        ...
        imageUrlRemote: 'https://i.ibb.co/55z32tw/long-sleeve.png',
      ...
      },
      {
        id: 33,
        name: 'Pink T-shirt',
        imageUrlRemote: 'https://i.ibb.co/RvwnBL8/pink-shirt.png',
      ...
      },
      {
        ...
        imageUrlRemote: 'https://i.ibb.co/VpW4x5t/roll-up-jean-shirt.png',
      ...
      },
      {
        ...
        imageUrlRemote: 'https://i.ibb.co/mh3VM1f/polka-dot-shirt.png',
